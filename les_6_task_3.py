...
Третий вариант (используется структура tuple)
"""
import random
import sys


list_numbers = tuple(random.randint(0, 20) for _ in range(10))  # Генерируем список чисел
min1 = list_numbers[0]
min2 = list_numbers[1]
...
Размер коллекции: 128
Размер переменной: 24
Размер переменной: 24

В третей версии программы за счет использования структуры tuple,
объем памяти под переменные получился заметно меньшим.
"""
